...
# This function runs the current cam for a given location on your desktop. spotNames are specific to Surfline API. It currently is not used in the app, but is a useful tool for testing. 
