...
class Collect:
    ...
    def startCollecting(self):                              # Collects data every 10 minutes for crowd. Should only run between hours of 05:00 and 8:00.
        ...
        self.addCrowdData()
        print('finished')
        schedule.every(10).minutes.do(self.addCrowdData)    # Add crowd data every 30 minutes.
        schedule.every(10).minutes.do(self.addBuoyData)     # Add buoy data every 30 minutes.
