        ...
        return (
            <div className="flex flex-col">
                <div className="flex p-2 bg-white justify-between sticky top-0">
                    ...
                    <div className='flex items-center gap-1 text-gray-600 px-2' onClick={handleSignIn}>
                        <div>Login</div>
                        <img src={login} className="w-3" />
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-10 py-10 items-center my-3'>
                    ...
                    <button className="bg-twosurfblue border-solid border-2 border-transparent hover:border-black hover:border-opacity-20 py-2 px-3 text-white font-bold rounded-lg hover:cursor-default" onClick={handleSignUp}>Get started</button>
                </div>
